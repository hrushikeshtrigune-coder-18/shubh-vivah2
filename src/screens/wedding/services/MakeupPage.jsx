...
const makeupData = [
    { id: '1', name: 'Glamour by Gloria', location: 'Goa', locality: 'Panjim', rating: '4.9', ratingValue: 4.9, reviews: 320, guests: 'Bridal', type: 'Airbrush', wmgAward: true, price: '₹ 15k', image: require('../../../../assets/Makeup/artist1.jpg'), category: 'Makeup', likes: '1.2k', description: 'Certified MUA specializing in bridal and party makeup.' },
    { id: '2', name: 'Divine Touch', location: 'Mumbai, MH', locality: 'Bandra', rating: '4.8', ratingValue: 4.8, reviews: 150, guests: 'Party', type: 'HD Makeup', wmgAward: false, price: '₹ 12k', image: require('../../../../assets/Makeup/artist2.jpg'), category: 'Makeup', likes: '850', description: 'Creating flawless looks for your special occasions.' },
    { id: '3', name: 'Stories by Joseph', location: 'Delhi, DL', locality: 'Saket', rating: '4.9', ratingValue: 4.9, reviews: 210, guests: 'Bridal', type: 'Traditional', wmgAward: true, price: '₹ 20k', image: require('../../../../assets/Makeup/artist3.jpg'), category: 'Makeup', likes: '2.1k', description: 'Award-winning artist known for natural and elegant styles.' },
    { id: '4', name: 'Elegant Brushes', location: 'Bangalore, KA', locality: 'Indiranagar', rating: '4.7', ratingValue: 4.7, reviews: 95, guests: 'Bridal', type: 'HD Makeup', wmgAward: false, price: '₹ 18k', image: require('../../../../assets/Makeup/artist1.jpg'), category: 'Makeup', likes: '600', description: 'Expert in high-definition makeup for long-lasting wear.' },
    { id: '5', name: 'Radiant Glow', location: 'Pune, MH', locality: 'Koregaon Park', rating: '4.6', ratingValue: 4.6, reviews: 80, guests: 'Party', type: 'Airbrush', wmgAward: false, price: '₹ 10k', image: require('../../../../assets/Makeup/artist2.jpg'), category: 'Makeup', likes: '450', description: 'Enhancing your natural beauty with premium products.' },
    { id: '6', name: 'The Makeup Studio', location: 'Chennai, TN', locality: 'T. Nagar', rating: '4.8', ratingValue: 4.8, reviews: 180, guests: 'Bridal', type: 'Traditional', wmgAward: true, price: '₹ 22k', image: require('../../../../assets/Makeup/artist3.jpg'), category: 'Makeup', likes: '1.5k', description: 'Traditional South Indian bridal makeup specialists.' },
];
...
const OUR_VENDORS = [
    {
        ...
        isLuxury: true,
        thumbnails: [
            require('../../../../assets/Makeup/artist1.jpg'),
            require('../../../../assets/Makeup/artist2.jpg'),
            require('../../../../assets/Makeup/artist3.jpg')
        ]
    },
    {
        id: '2',
                ...
                <View style={styles.sectionContainer}>
                    ...
                    >
                        {OUR_VENDORS.map((item) => (
                            <TouchableOpacity key={item.id} style={styles.vendorCard} onPress={() => navigation.navigate('MakeupArtistsScreen', { item })}>
                    ...
                    <View style={{ paddingBottom: 20 }}>
                        {filteredData.map((item, index) => {
                            if (index % 3 === 0) {
                                ...
                                return (
                                    <TouchableOpacity key={item.id} style={styles.topPickCard} onPress={() => navigation.navigate('MakeupArtistsScreen', { item })}>
                                ...
                                return (
                                    <View key={`grid-row-${index}`} style={styles.gridContainer}>
                                        ...
                                        <TouchableOpacity style={styles.gridCard} onPress={() => navigation.navigate('MakeupArtistsScreen', { item })}>
                                        ...
                                        {nextItem && (
                                            <TouchableOpacity style={styles.gridCard} onPress={() => navigation.navigate('MakeupArtistsScreen', { item: nextItem })}>
