...
const mehandiDefault = require('../../../../assets1/images/mehandi.jpg');
const mehandi1 = require('../../../../assets1/images/mehandi1.jpg');
const mehandiPortrait = require('../../../../assets1/images/mehandiF.jpg');
                                ...
                                {[
                                    ...
                                    <View key={idx} style={styles.faqItem}>
                                        ...
                                        >
                                            ...
                                            <Ionicons
                                                name={expandedFAQ === idx ? "remove" : "add"}
                                                size={24}
                                                color="#999"
                                            />
                                        </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    faqAnswerContainer: { paddingVertical: 10, paddingRight: 20 },
    faqAnswer: { fontFamily: 'Outfit_400Regular', fontSize: 14, color: '#666', lineHeight: 20 },
