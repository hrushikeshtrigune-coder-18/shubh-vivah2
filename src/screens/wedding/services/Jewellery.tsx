...
const VideoHero = memo(({ insets, onSearchPress, onGoBack, searchQuery, setSearchQuery, selectedLocation, onLocationPress }: VideoHeroProps) => {
        ...
        <View style={styles.heroWrapper}>
            <View style={styles.heroContainer}>
                ...
                <View style={[styles.headerIconsRow, { top: insets.top + 10 }]}>
                    <TouchableOpacity onPress={onGoBack} style={styles.backBtnWrapper}>
                ...
                <View style={styles.sectionContainer}>
                    ...
                    >
                        {OUR_VENDORS.map((item) => (
                            <TouchableOpacity key={item.id} style={styles.vendorCard} onPress={() => router.push({ pathname: '/routes/JewelleryDetails', params: { item: JSON.stringify(item) } })}>
                    ...
                    <View style={{ paddingBottom: 20 }}>
                        {filteredData.map((item, index) => {
                            if (index % 3 === 0) {
                                ...
                                return (
                                    <TouchableOpacity key={item.id} style={styles.topPickCard} onPress={() => router.push({ pathname: '/routes/JewelleryDetails', params: { item: JSON.stringify(item) } })}>
                                ...
                                return (
                                    <View key={`grid-row-${index}`} style={styles.gridContainer}>
                                        ...
                                        <TouchableOpacity style={styles.gridCard} onPress={() => router.push({ pathname: '/routes/JewelleryDetails', params: { item: JSON.stringify(item) } })}>
                                        ...
                                        {nextItem && (
                                            <TouchableOpacity style={styles.gridCard} onPress={() => router.push({ pathname: '/routes/JewelleryDetails', params: { item: JSON.stringify(nextItem) } })}>
