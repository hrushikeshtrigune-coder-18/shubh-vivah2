                ...
                <View style={styles.sectionContainer}>
                    ...
                    >
                        {OUR_VENDORS.map((item) => (
                            <TouchableOpacity key={item.id} style={styles.vendorCard} onPress={() => navigation.navigate('routes/MakeupArtistDetails', { item })}>
                    ...
                    <View style={{ paddingBottom: 20 }}>
                        {filteredData.map((item, index) => {
                            if (index % 3 === 0) {
                                ...
                                return (
                                    <TouchableOpacity key={item.id} style={styles.topPickCard} onPress={() => navigation.navigate('routes/MakeupArtistDetails', { item })}>
                                ...
                                return (
                                    <View key={`grid-row-${index}`} style={styles.gridContainer}>
                                        ...
                                        <TouchableOpacity style={styles.gridCard} onPress={() => navigation.navigate('routes/MakeupArtistDetails', { item })}>
                                        ...
                                        {nextItem && (
                                            <TouchableOpacity style={styles.gridCard} onPress={() => navigation.navigate('routes/MakeupArtistDetails', { item: nextItem })}>
