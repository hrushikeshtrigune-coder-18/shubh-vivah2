...
const styles = StyleSheet.create({
    ...
    floatingActionTier: { paddingHorizontal: 20, paddingBottom: Platform.OS === 'ios' ? 30 : 20, paddingTop: 10, backgroundColor: '#FFF', borderTopWidth: 1, borderTopColor: '#EEE' },
    contactUsBtn: { width: '100%', height: 60, borderRadius: 30, backgroundColor: '#F29502', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 12, elevation: 6, shadowColor: '#F29502', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 6 },
    contactUsBtnText: { color: '#FFF', fontFamily: 'Outfit_700Bold', fontSize: 18, letterSpacing: 0.5 },
