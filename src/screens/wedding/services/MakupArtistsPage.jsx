...
const PORTFOLIO_IMAGES = [
    { id: '1', source: require('../../../../assets/Makeup/artist1.jpg'), height: 250, label: 'Bridal Glow', category: 'bridal' },
    { id: '2', source: require('../../../../assets/Makeup/artist2.jpg'), height: 180, label: 'Party Glam', category: 'party' },
    { id: '3', source: require('../../../../assets/Makeup/artist3.jpg'), height: 220, label: 'Engagement Look', category: 'engagement' },
    { id: '4', source: require('../../../../assets/Makeup/artist1.jpg'), height: 200, label: 'Sangeet Vibes', category: 'party' },
    { id: '5', source: require('../../../../assets/Makeup/artist2.jpg'), height: 240, label: 'Reception Royal', category: 'bridal' },
    { id: '6', source: require('../../../../assets/Makeup/artist3.jpg'), height: 190, label: 'Haldi Special', category: 'engagement' },
];
...
// Mock Videos
const VIDEOS_DATA = [
    { id: '1', thumbnail: require('../../../../assets/Makeup/artist1.jpg'), title: 'Bridal Makeup Tutorial', duration: '5:15' },
    { id: '2', thumbnail: require('../../../../assets/Makeup/artist2.jpg'), title: 'Party Look Transformation', duration: '3:30' },
    { id: '3', thumbnail: require('../../../../assets/Makeup/artist3.jpg'), title: 'Client Testimonials', duration: '1:45' },
];

// Mock Media
const MEDIA_DATA = [
    { id: '1', image: require('../../../../assets/Makeup/artist1.jpg'), title: 'Featured in WedMeGood', source: 'WedMeGood', date: 'Oct 2024' },
    { id: '2', image: require('../../../../assets/Makeup/artist2.jpg'), title: 'Top 10 MUAs in Goa', source: 'WeddingSutra', date: 'Aug 2024' },
];

const MakupArtistsPage = ({ route, navigation }) => {
    ...
    const heroImages = React.useMemo(() => {
        ...
        return [
            { id: 'hero-1', source: require('../../../../assets/Makeup/artist1.jpg') },
            { id: 'hero-2', source: require('../../../../assets/Makeup/artist2.jpg') },
            { id: 'hero-3', source: require('../../../../assets/Makeup/artist3.jpg') },
        ];
    }, [item]);
            ...
            >
                ...
                <View style={styles.sheetContainer}>
                    ...
                    <Animated.View style={[styles.avatarContainer, animatedAvatarStyle]}>
                        <Image source={item?.image || require('../../../../assets/Makeup/artist1.jpg')} style={styles.avatarImage} resizeMode="cover" />
                    </Animated.View>
