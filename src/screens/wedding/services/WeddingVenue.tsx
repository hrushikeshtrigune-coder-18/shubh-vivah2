                    ...
                    >
                        ...
                        <View style={styles.profileInfoContent}>
                            ...
                            <View ref={reviewsRef} style={styles.profileReviewsSection}>
                                    ...
                                    {[
                                        ...
                                        >
                                            <View style={styles.faqHeader}>
                                                <Text style={[styles.faqQuestion, expandedFAQ === i && { color: COLORS.primary }]}>{faq.q}</Text>
                                                <Ionicons name={expandedFAQ === i ? "remove" : "add"} size={20} color={expandedFAQ === i ? COLORS.primary : "#999"} />
                                            </View>
                                            {expandedFAQ === i && (
                                ...
                                {/* Final Contact CTA */}
                                <TouchableOpacity
                                    style={styles.profileContactBtn}
                            ...
                            <View style={styles.contactHeader}>
                                <View>
                                    ...
                                    <Text style={styles.contactSubTitle}>
                                        Schedule a tour of {selectedVendor?.name || 'Grand Venue'}
                                    </Text>
                                </View>
                                <TouchableOpacity
                    ...
                    <LinearGradient colors={['transparent', 'rgba(0,0,0,0.9)']} style={styles.modalContent}>
                        ...
                        <View style={styles.modalActions}>
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => Alert.alert('Contact Vendor', 'Would you like to call the vendor?', [
                                    { text: 'Call', onPress: () => Linking.openURL(`tel:+91${Math.floor(Math.random() * 9000000000) + 1000000000}`) },
...
const styles = StyleSheet.create({
    ...
    faqAnswer: { fontFamily: 'Outfit_400Regular', fontSize: 13, color: '#666', marginTop: 12, lineHeight: 20 },
    ...
    contactTitle: { fontSize: 24, color: '#C61E1A', fontFamily: 'Outfit_700Bold' },
    contactSubTitle: { fontSize: 13, color: '#F29502', marginLeft: 6, fontFamily: 'Outfit_600SemiBold' },
    closeContactBtn: { backgroundColor: '#F5F5F5', borderRadius: 25, padding: 8 },
    contactLabel: { fontSize: 13, color: '#C61E1A', marginTop: 12, marginBottom: 6, fontFamily: 'Outfit_700Bold' },
    contactInputWrapper: {
        flexDirection: 'row',
        alignItems: 'center',
    ...
    contactInput: { flex: 1, fontSize: 16, color: '#333', fontFamily: 'Outfit_500Medium' },
    ...
    backContactText: { fontSize: 16, color: '#666', fontFamily: 'Outfit_700Bold' },
    confirmContactText: { fontSize: 16, color: '#FFF', fontFamily: 'Outfit_700Bold' },
});
