        ...
        <View style={styles.profileContainer}>
            ...
            >
                ...
                <View style={{ paddingTop: 20, paddingHorizontal: 20 }}>
                    ...
                    {/* Contact Us Button at end of page */}
                    <TouchableOpacity style={styles.contactUsBtnInline} onPress={() => setIsContactModalVisible(true)}>
...
const styles = StyleSheet.create({
    ...
    contactUsBtnInline: { width: '100%', height: 65, borderRadius: 35, backgroundColor: '#F29502', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 12, elevation: 12, shadowColor: '#F29502', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.4, shadowRadius: 10, marginTop: 10, marginBottom: 40 },
